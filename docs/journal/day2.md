...
While I’ve successfully silenced the red lines, I’m still a bit fuzzy on Generics in useState. I used useState<Coin[]>([]) to ensure the list starts as an empty array rather than null., but I want to understand more about why TypeScript needs that explicit "contract" instead of just figuring it out from the initial value.
